...
const sortOptions = [
  ...
  { name: "Newest", sort: "createdAt", current: false, order: "desc" },
];
...
export default function ProductList() {
  ...
  useEffect(() => {
    ...
    if (params.id) {
      ...
      handlePage(1);
      console.log("dwkjdk"+Math.ceil(totalItems/ITEMS_PER_PAGE))
    }
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          ...
          <div>
            ...
            >
              ...
              <div
                onClick={(e) => {
                  if (page < totalItems / ITEMS_PER_PAGE) handlePage(page + 1);
                }}
